...
cursor.execute("""INSERT INTO object_types(object_type) VALUES('env'), ('farm'), ('farm_role'), ('server')""")

cursor.execute("""CREATE TABLE IF NOT EXISTS billing_aggregation
                  (object_type TEXT NOT NULL, object_id VARCHAR(32), cost REAL, FOREIGN KEY(object_type) REFERENCES object_types(id))""")
